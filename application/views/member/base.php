                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <div class="row w-states">
                                                ...
                                                <div class="col-xs-6 ">
                                                    <a href="#" class="btn set_warning btn-block">
                                                        <span class="value"><?php $data = $this->db_model->sum('amount', 'donation_record', array('userid' => $this->session->user_id));
                                                                            if ($data <= "0") {
                                                ...
                                                <div class="col-xs-6">
                                                    <a href="<?php echo base_url()?>member/topup_list" class="btn btn-warning btn-block">
                                                        <span class="value">
                                                        <?php echo config_item('currency').'&nbsp;';echo ($topup_with) ? $topup_with : '300'; ?>
                                                                            </span>
