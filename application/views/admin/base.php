        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                <div class="page-logo">
                    ...
                    <div class="menu-toggler sidebar-toggler hamberge">
                        <span></span>
                    </div>
                </div>
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right" id="nav_dued">
        ...
        <div class="page-container">
                        ...
                        <ul class="sidemenu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <?php if (config_item('enable_help_plan') !== "Yes") { ?>
                                <?php if (!isset($this->session->designation) || $this->session->designation['earning_manage'] == "1") { ?>
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo site_url('admin/donar_reward_list') ?>" class="nav-link ">
                                            <i class="fa fa-gift"></i>
                                            <span class="title">Reward Donar</span>
                                        </a>
                                    </li>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="page-bar set_margin_fixed">
                        <div class="page-title-breadcrumb fixed_padding" >
                            <div class=" pull-left">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="overview-panel purple">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="23"><?php echo $total_member = $this->db_model->count_all('member') ?></p>
                                            <p>Total Users</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="overview-panel blue-bgcolor">
                                        ...
                                        <div class="value white">
                                            <p class="sbold addr-font-h1" data-counter="counterup" data-value="48"><?php if ($earnnings == "") {
                                                                                                                    ...
                                                                                                                    echo number_format($total_member * 200, 2) . '&nbsp;/&nbsp;' . number_format($earnnings, 2); ?></p>
                                            <p>Earnings</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-6 set_min_width">
                                ...
                                <div class="card card-topline-aqua">
                                    ...
                                    <div class="card-body no-padding height-9">
                                        <div class="row">
                                            ...
                                            <button type="submit" class="btn margin btn-success btn-lg pull-right glyphicon glyphicon-plus-sign"></button>
                                            <?php echo form_close() ?>
                                        </div>
                                    </div>
                                </div>
