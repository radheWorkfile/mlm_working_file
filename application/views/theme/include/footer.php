			...
			<div class="row">
				<div class="col-lg-4 col-sm-6 col-xs-12" style="margin-top:30px;">
					<div class="footer_logo">
						...
						<p class="text_gray">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eveniet, obcaecati!</p>
					</div>
				...
				<div class="col-lg-4 col-sm-6 col-xs-12" style="margin-top:30px;">
					...
					<div class="d-flex my-3">
						<div class="left">
							<i class="fa fa-phone font-size-sett"></i>
						</div>
						<div>
							<a href="<?php echo config_item('phone');?>" class="text_gray add-kle"><?php echo config_item('phone');?></a>
						</div>
					</div>
